...
public class AccountInfoPanel extends JPanel implements INewTab, IAccountHandler {
    ...
    public PortfolioModel m_portfolioModel = new PortfolioModel();
    public JTable m_portfolioTable = new Table(m_portfolioModel);
...
//	}
    ...
    static public class PortfolioModel extends AbstractTableModel {
	public HashMap<Integer, Position> m_portfolioMap = new HashMap<Integer, Position>();
