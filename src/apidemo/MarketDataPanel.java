...
//    public void stuartScan(){                                   //SCR!
//        ScannerRequestPanel srp = new ScannerRequestPanel();
//        srp.onGo();
//        
//    }
//    
    ...
    static class ScannerResultsPanel extends NewTabPanel implements IScannerHandler {
        ...
        public void scannerData(int rank, final NewContractDetails contractDetails, String legsStr) {
            //get symbols list from eoddata, not IB. //SCR!
//            ApiDemo.scannedDescriptions.add(contractDetails.contract().description());                       //SCR!
//
//            //get "Expiry" "Strike" "Multiplier" "Exchange" "Currency" "Local symbol" "Trading class"
//            
////            System.out.println(contractDetails.contract().description() +" "+ contractDetails.contract().localSymbol());            
//            
////            contractDetails.contract().
//            NewContract nc = contractDetails.contract();
////            
//            System.out.format("Loc sym: %s, Expiry: %s, Strike: %s, Multiplier: %s, Exchange: %s, Currency: %s, Trading class: %s, Primary Exchange: %s,  Sec ID: %s%n",
//                    nc.localSymbol(), nc.expiry(), nc.strike(), nc.multiplier(), nc.exchange(), nc.currency(), nc.tradingClass(),
//                    nc.primaryExch(), nc.secId());
//            
//            
