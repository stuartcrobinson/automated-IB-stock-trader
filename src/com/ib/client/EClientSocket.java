...
public class EClientSocket {
    ...
    public synchronized void eConnect(Socket socket, int clientId) throws IOException {
        ...
        ApiDemo.myPrintln("Server Version:" + m_serverVersion);
        if (m_serverVersion >= 20) {
            m_TwsTime = m_reader.readStr();
            ApiDemo.myPrintln("TWS Time at connection:" + m_TwsTime);
        }
...
//        Stock symbolInfo;
//        if (ApiController.m_topMktDataMapStuart.containsKey(id)) {
//            symbolInfo = ApiController.m_topMktDataMapStuart.get(id).stock;
//            ApiDemo.myPrintln(ApiController.m_topMktDataMapStuart.size());
//            ApiDemo.myPrintln("here's an error: <" + symbolInfo.toString() + "> " + id + " " + errorCode + " " + errorMsg);                         //SCR!
//            ApiDemo.myPrintln("error id: " + id + ", " + symbolInfo.toString());                         //SCR!

//        } 
//        else 
//            ApiDemo.myPrintln("here's an error: " + id + " " + errorCode + " " + errorMsg);                         //SCR!

//            ApiDemo.erroredReqIds.add(id);                          //SCR!
        ApiDemo.curErr = errorCode;
