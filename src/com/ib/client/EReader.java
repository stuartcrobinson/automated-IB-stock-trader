    ...
    protected boolean processMsg(int msgId) throws IOException {
        ...
        switch (msgId) {
            ...
            case NEWS_BULLETINS: {
                ...
                //this outputs non-error messages i think? 
                System.out.format("here's a message: %d, %d, %s, %s %n", newsMsgId, newsMsgType, newsMessage, originatingExch);//SCR!!
...
//        System.out.println("message?: "+ str);        //SCR!
