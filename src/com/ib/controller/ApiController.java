...
//import apidemo.ApiDemo.StuartHandler;
...
//    public static HashMap<Integer, StuartHandler> m_topMktDataMapStuart = new HashMap();
    ...
    public void error(int id, int errorCode, String errorMsg) {
        ...
        if (errorCode == 200) {
//            ApiDemo.lastErroredStockRequestID = id;                     //SCR!
...
//    /**
//     * and set handler reqId SCR!
//     */
//    public int reqTopMktData(NewContract contract, String genericTickList, boolean snapshot, StuartHandler handler) {
//        int reqId = m_reqId++;
////        handler.reqId = reqId;
//        m_topMktDataMap.put(reqId, handler);
////        System.out.println("putting req and handler in map " + reqId + " " + handler.toString());
//        m_topMktDataMapStuart.put(reqId, handler);                                                      //SCR!
////        System.out.println(m_topMktDataMapStuart.get(reqId).toString());
//        m_client.reqMktData(reqId, contract.getContract(), genericTickList, snapshot);
//        sendEOM();
//        return reqId;
//    }
