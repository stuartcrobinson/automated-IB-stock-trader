...
public class Formats {
	...
	public static final SimpleDateFormat TIME = new SimpleDateFormat( "HH:mm:ss"); // format for display
...
//            System.out.println("IB date formatting...");
//            System.out.println(ms);                                     //SCR! remove
//            System.out.println( TIME.format( new Date( ms) ));
